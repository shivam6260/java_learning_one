...
/*
| Base Method | Derived Method | Allowed? | Why?                                 |
| ----------- | -------------- | -------- | ------------------------------------ |
| static      | static         | ✅        | Method hiding (not overriding)       |
| instance    | instance       | ✅        | Proper method overriding             |
| static      | instance       | ❌        | Cannot override static with instance |
| instance    | static         | ❌        | Cannot hide instance with static     |
